...
namespace DataLayer
{
    public class Habitaciones
    {
        ...
        public bool AgregarHabitacion(int numero, string descripcion, int huespedes, int idUsuario)
        {
            ...
            {
                con.Open();
                using (SqlCommand cmd = new SqlCommand("INSERT INTO habitaciones (numero, descripcion, huespedes, id_usuario) VALUES (@numero, @descripcion, @huespedes, @idUsuario)", con))
                {
